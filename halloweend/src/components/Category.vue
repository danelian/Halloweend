...
<template>
  <section id="category" class="flex flex-col items-center py-32">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 place-items-center">
      <div v-for="category of categories" v-bind:key="category.title" class="text-white grid place-items-center gap-5 text-center">
        <div class="p-10">
          <img v-bind:src="category.image" class="w-full" alt="category1">
        </div>
